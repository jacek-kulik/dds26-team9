...
ORDER_WEB_REPLICAS="${ORDER_WEB_REPLICAS:-1}"
ORDER_WORKER_REPLICAS="${ORDER_WORKER_REPLICAS:-1}"
ORCH_WORKER_REPLICAS="${ORCH_WORKER_REPLICAS:-1}"
STOCK_WEB_REPLICAS="${STOCK_WEB_REPLICAS:-1}"
STOCK_WORKER_REPLICAS="${STOCK_WORKER_REPLICAS:-1}"
