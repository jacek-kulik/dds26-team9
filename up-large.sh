...
COMPOSE_FILE="docker-compose-large.yml"

ORDER_WEB_REPLICAS="${ORDER_WEB_REPLICAS:-30}"
ORDER_WORKER_REPLICAS="${ORDER_WORKER_REPLICAS:-10}"
ORCH_WORKER_REPLICAS="${ORCH_WORKER_REPLICAS:-30}"
STOCK_WEB_REPLICAS="${STOCK_WEB_REPLICAS:-1}"
STOCK_WORKER_REPLICAS="${STOCK_WORKER_REPLICAS:-10}"
USER_WEB_REPLICAS="${USER_WEB_REPLICAS:-1}"
USER_WORKER_REPLICAS="${USER_WORKER_REPLICAS:-5}"
DETACH="${DETACH:-1}"
