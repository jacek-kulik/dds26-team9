...
ORDER_WEB_REPLICAS="${ORDER_WEB_REPLICAS:-15}"
ORDER_WORKER_REPLICAS="${ORDER_WORKER_REPLICAS:-5}"
ORCH_WORKER_REPLICAS="${ORCH_WORKER_REPLICAS:-15}"
STOCK_WEB_REPLICAS="${STOCK_WEB_REPLICAS:-1}"
STOCK_WORKER_REPLICAS="${STOCK_WORKER_REPLICAS:-5}"
