...
ORDER_WEB_REPLICAS="${ORDER_WEB_REPLICAS:-29}"
ORDER_WORKER_REPLICAS="${ORDER_WORKER_REPLICAS:-8}"
ORCH_WORKER_REPLICAS="${ORCH_WORKER_REPLICAS:-29}"
STOCK_WEB_REPLICAS="${STOCK_WEB_REPLICAS:-4}"
STOCK_WORKER_REPLICAS="${STOCK_WORKER_REPLICAS:-8}"
USER_WEB_REPLICAS="${USER_WEB_REPLICAS:-4}"
